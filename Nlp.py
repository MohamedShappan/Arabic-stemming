...
arabieeee = ['ا', 'أ', 'ب', 'ت', 'ث', 'ج', 'ح', 'خ', 'د', 'ذ', 'ر', 'ز', 'س', 'ش', 'ص', 'ض', 'ط', 'ظ', 'ع', 'غ', 'ف',
             'ق', 'ك', 'ل', 'م', 'ن', 'ه', 'و', 'ي', 'ة', 'ؤ', 'ئ']

prefixes = ['وكال', 'وبال', 'فبال', 'وال', 'فال', 'كال', 'بال', 'ولل', 'فلل', 'ال', 'لل', 'لي', 'لت', 'لن', 'لا', 'فل',
            'فس', 'في', 'فت', 'فن', 'فا', 'سي', 'ست', 'سن', 'سا', 'ول', 'وس', 'وي', 'وت', 'ون', 'وا', 'ل', 'ب', 'ف',
            'س', 'و', 'ي', 'ت', 'ن', 'ا']
suffixes = ['وهم', 'وك', 'هم', 'ها', 'كم', 'هن', 'هما', 'ون', 'ما', 'تم', 'ني', 'وا', 'كن', 'يا', 'نا', 'ين', 'ات',
            'ان', 'ة', 'و',
            'ك', 'ه', 'ي', 'ن']
...
def steaming_arabic():
    ...
    # words = words.replace('_',' ',100)
    # words = words.replace('-',' ',100)
    # words = words.replace('.',' ',100)
    # words = words.replace(',',' ',100)
    # words = words.replace('(',' ',100)
    # words = words.replace(')',' ',100)
